...
- [👥 **팀원 소개**](#-팀원-소개)
- [💼 **역할 분담**](#-담당-파트)
- [🛠 **사용 기술 스택**](#%EF%B8%8F-사용-기술-스택-tech-stack)
- [📋 **메뉴 구조도**](#-메뉴-구조도)
- [🖥 **화면 구현**](#🖥-화면-구현)
- [💡 **느낀점**](#느낀점)
...
<div align="center">
  <img src="https://img.icons8.com/ios-filled/500/headphones.png" width="100" />
</div>
...
<br><br>
**Music APP Project**는 Android Studio 기반의 **모바일 음악 재생 앱**으로,  
사용자가 **자신의 라이브러리에서 음악을 탐색, 재생, 관리**할 수 있는 기능을 제공합니다.  

### 🎯 주요 개발 목적
- 직관적인 **로컬 음악 탐색 및 재생 인터페이스** 구현
- **사용자 맞춤형 플레이리스트**와 **테마 커스터마이징** 제공
- 어두운 환경에서도 눈에 부담 없는 **다크 모드 UI 지원**
- MVVM 아키텍처와 효율적인 **백엔드 연동**을 통한 데이터 구조화
...
> 👀 **사용자의 일상 속 음악 경험을 풍부하게 만들기 위한 고민과 구현이 녹아든 앱입니다.**  
> 기능적 완성도는 물론, 디자인 감성과 협업 방식까지 모두 담아낸 저희만의 결과물입니다.
...
| 메뉴            | 설명                                                  | 화면 이미지                                                      |
|-----------------|-------------------------------------------------------|------------------------------------------------------------------|
| 초기화면        | 초기화면                                                 | ![메인화면](https://github.com/user-attachments/assets/79d5f01b-9bc3-4d81-b745-6f87563100d4) |
| 🏠 **홈 화면**  | 사용자에게 메인 화면을 제공하며, 음악 탐색, 보관함, 위시리스트 등을 쉽게 접근할 수 있는 기능을 제공. | ![홈화면](https://github.com/user-attachments/assets/65ca3e4e-1749-428c-8bd1-6a2db19f0a7b) <br> ![홈 화면](https://github.com/user-attachments/assets/example-home.gif) |
| 🔍 **검색 기능** | 아티스트, 앨범, 곡명으로 빠르고 정확하게 음악을 검색할 수 있는 기능. | ![검색화면](https://github.com/user-attachments/assets/a491418e-5bbd-40a2-8aa5-eb2cd27af22b) <br> ![검색 기능](https://github.com/user-attachments/assets/example-search.gif) |
| 🔍 **아티스트**  | 아티스트, 앨범, 곡명으로 빠르고 정확하게 음악을 검색할 수 있는 기능. | ![아티스트화면](https://github.com/user-attachments/assets/c9b108cb-4884-446e-b8f8-1722bc59f7f7) <br> ![검색 기능](https://github.com/user-attachments/assets/example-search.gif) |
| 📂 **보관함**    | 사용자가 좋아하는 곡을 저장하고 관리할 수 있는 공간으로, 즐겨찾기와 플레이리스트 관리 가능. | ![위시리스트화면](https://github.com/user-attachments/assets/3c2fbddd-821a-4bb8-962b-d630ed9978b0) <br> ![보관함](https://github.com/user-attachments/assets/example-library.gif) |
