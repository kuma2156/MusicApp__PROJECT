...
**Music APP Project**는 Android Studio를 기반으로 Kotlin과 Java를 활용해 개발한 **모바일 음악 재생 애플리케이션**입니다.  
사용자 친화적인 인터페이스와 효율적인 재생 기능을 제공하여, 기기 내 저장된 음악을 쉽고 편리하게 감상할 수 있도록 설계되었습니다.

이 프로젝트는 단순한 음악 재생을 넘어 **사용자 맞춤형 경험**에 중점을 두고 개발되었으며, 다음과 같은 기능을 핵심으로 합니다:

- 🎵 **로컬 음악 파일 탐색 및 재생**
- 🔀 **다양한 재생 컨트롤 (일시정지, 이전곡, 다음곡, 반복, 랜덤)**
- 🌙 **다크 모드 지원으로 야간 사용성 강화**
- 📁 **사용자 정의 플레이리스트 생성 및 관리**
- 🎨 **테마 색상 커스터마이징 기능 제공**

또한, 프로젝트는 MVVM 아키텍처를 바탕으로 구성되었으며,  
**협업과 코드 유지보수의 효율성**을 높이기 위해 GitHub 기반 브랜치 전략, 컨벤션을 철저히 지켜가며 개발하였습니다.

> "내가 원하는 방식으로 음악을 듣는 가장 간편한 방법"  
> 이 슬로건을 바탕으로, 사용자의 취향과 습관을 고려한 직관적이고 유연한 앱을 목표로 했습니다.
